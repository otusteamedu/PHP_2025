    ...
    public function __invoke(): Response
    {
        try {
            ...
            $sql = "CREATE TABLE IF NOT EXISTS food_food (
                    id VARCHAR(36) UNIQUE NOT NULL, title VARCHAR(255), status VARCHAR(255), status_created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status_updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, 
