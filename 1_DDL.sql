...
(
    ...
    CONSTRAINT seats_halls_fk FOREIGN KEY (hall_id) REFERENCES public.halls (id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
    ...
    CONSTRAINT sessions_films_fk FOREIGN KEY (film_id) REFERENCES public.films (id),
    CONSTRAINT sessions_halls_fk FOREIGN KEY (hall_id) REFERENCES public.halls (id)
);
...
(
    ...
    CONSTRAINT orders_tickets_fk FOREIGN KEY (ticket_id) REFERENCES public.tickets (id)
);
