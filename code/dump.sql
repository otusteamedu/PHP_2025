...
CREATE TABLE public.session_hall
(
...
ALTER TABLE public.session_hall
    OWNER TO "AK";
...
ALTER TABLE public.about_films
    OWNER TO "AK";
...
ALTER TABLE public.about_films_json
    OWNER TO "AK";
...
ALTER TABLE public.attributes_types
    ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
SELECT f.title,
       ...
       string_agg(CASE WHEN v.value_date > CURRENT_DATE AND v.value_date <= (CURRENT_DATE + 20) THEN a.title END,
                  ', ')                                                         AS period
FROM public."values" v
         JOIN public.attributes a ON v.attribute_id = a.id
...
ALTER TABLE public.service_dates
    OWNER TO "AK";
...
WHERE d.value >= CURRENT_DATE
  AND d.value <= (CURRENT_DATE + 20);


ALTER TABLE public.workd
    OWNER TO "AK";
...
INSERT INTO public.values (type_id, attribute_id, film_id, value_text)
VALUES (5, 7, 1, 'По версии IMDb Считается одним из величайших фильмов в истории кино');
INSERT INTO public.values (type_id, attribute_id, film_id, value_text)
VALUES (5, 1, 1, 'Критики и зрители отмечают сильный сценарий, режиссуру и актерскую игру');
INSERT INTO public.values (type_id, attribute_id, film_id, value_boolean)
VALUES (3, 8, 2, true);
INSERT INTO public.values (type_id, attribute_id, film_id, value_boolean)
VALUES (3, 8, 1, false);
INSERT INTO public.values (type_id, attribute_id, film_id, value_boolean)
...
INSERT INTO public.values (type_id, attribute_id, film_id, value_text)
VALUES (5, 1, 2,
        'Считается шедевром мирового кинематографа. Хвалят режиссуру Фрэнсиса Форда Копполы и актерскую игру, особенно Марлона Брандо');
INSERT INTO public.values (type_id, attribute_id, film_id, value_date)
VALUES (6, 4, 2, '1972-05-14');
INSERT INTO public.values (type_id, attribute_id, film_id, value_date)
VALUES (6, 6, 1, '2025-12-16');
INSERT INTO public.values (type_id, attribute_id, film_id, value_date)
VALUES (6, 4, 1, '1994-07-23');
INSERT INTO public.values (type_id, attribute_id, film_id, value_date)
VALUES (6, 3, 2, '1972-04-24');
INSERT INTO public.values (type_id, attribute_id, film_id, value_date)
VALUES (6, 3, 1, '1994-07-23');
INSERT INTO public.values (type_id, attribute_id, film_id, value_date)
VALUES (6, 5, 1, '2025-12-15');
INSERT INTO public.values (type_id, attribute_id, film_id, value_date)
VALUES (6, 6, 2, '2025-12-21');
INSERT INTO public.values (type_id, attribute_id, film_id, value_date)
VALUES (6, 5, 2, '2025-12-22');
