...
class EmailVerifier
{
    ...
    private function verifyEmail(string $email): array
    {
        ...
        // Проверка разных типов DNS записей
        $dnsValid = $this->checkDomain(explode('@', $email)[1]);
    ...
    private function checkDomain($domain) {
        ...
        $checks = [
            'A'  => checkdnsrr($domain, 'A'),     // IPv4 address
            'AAAA' => checkdnsrr($domain, 'AAAA') // IPv6 address
        ];
