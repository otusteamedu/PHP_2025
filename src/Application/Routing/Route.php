...
class Route
{
     ...
     * @return void
     */
    public static function get(string $name, array $options): void {
     ...
     * @return void
     */
    public static function post(string $name, array $options): void {
     ...
     * @return void
     */
    public static function put(string $name, array $options): void {
     ...
     * @return void
     */
    private static function setRoute(string $name, string $method, array $options): void {
