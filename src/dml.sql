...
-- Титаник
insert into value (movieId, attributeId, moneyVal) values (2,  1, 1546456.43);
...
-- Начало
insert into value (movieId, attributeId, moneyVal) values (3,  1, 1546456.43);
...
-- Матрица
insert into value (movieId, attributeId, moneyVal) values (4,  1, 1546456.43);
...
-- Интерстеллар
insert into value (movieId, attributeId, moneyVal) values (5,  1, 1546456.43);
...
-- Побег из Шоушенка
insert into value (movieId, attributeId, moneyVal) values (7,  1, 1546456.43);
...
-- Список Шиндлера
insert into value (movieId, attributeId, moneyVal) values (8,  1, 1546456.43);
...
-- Криминальное чтиво
insert into value (movieId, attributeId, moneyVal) values (19,  1, 1546456.43);
...
-- Трон: Наследие
insert into value (movieId, attributeId, moneyVal) values (10,  1, 1546456.43);
