...
-- контейнерами, поэтому завышать effective_cache_size нельзя: планировщик
-- получит недостоверную оценку доступного кэша.
...
-- случайное чтение значительно дешевле → 1.1 (типичное значение для SSD).
