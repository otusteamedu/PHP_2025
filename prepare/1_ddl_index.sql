...
CREATE INDEX id_film_session_date_start ON film_session ((date_start::date));
...
CREATE INDEX id_client_date_buy ON client ((date_buy::date));
---------------------------------------------------------------------
CREATE TABLE
    ticket (
        id SERIAL PRIMARY KEY,
...
CREATE INDEX id_ticket_by_session ON ticket(id_session);
---------------------------------------------------------------------