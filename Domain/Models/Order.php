 ...
 *     @OA\Property(property="payment_link", type="string"),
 *     @OA\Property(
...
class Order
{
     ...
     */
    public function setProduct(?string $product_name): void
    {
     ...
     */
    public function setPrice(?float $product_price): void
    {
    ...
    public function toArray(): array
    {
        return [
            ...
            'payment_link' => $this->status === 'created' ? "http://fast_food_restaurant/orders/{$this->id}/pay" : 'Заказ оплачен'
        ];
    }
}
